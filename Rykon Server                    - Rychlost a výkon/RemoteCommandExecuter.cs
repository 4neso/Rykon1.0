    ...
    public class RemoteCommandExecuter
    {
        ...
        internal void proceeed()
        {
            switch (ComType)
            {
                ...
                case RemoteCommandType.MessageBox: AppHelper.EnormusMessageBox(MessageBoxCap); this.Result = "msgbx sent"; break;
                case RemoteCommandType.CloseProcess:
                    {
                        string r = "";
                        AppHelper.CloseProcess(ProcessName); 
                        this.Result = "closed=" + r;

                        break;
                    }
                case RemoteCommandType.CloseAllProcess: this.Result = "closed=" + AppHelper.CloseProcessAll(ProcessName); break;
